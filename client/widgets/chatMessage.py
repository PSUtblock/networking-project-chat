...
class ChatMessage:
    def __init__(self, parent, user, message, timestamp):
        ...
        self.text_message = Text(self.container, text=message, size=12, align="left", color="white",  width="fill")

        self.time_stamp = Text(self.container, text=timestamp, color="white", size=12)
